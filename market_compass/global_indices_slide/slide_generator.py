...
BASE_WIDTH = 900
BASE_HEIGHT = 321
COMBINED_WIDTH_PX = BASE_WIDTH * SCALE_FACTOR   # 2700
COMBINED_HEIGHT_PX = BASE_HEIGHT * SCALE_FACTOR  # 963

# PowerPoint placement (cm)
COMBINED_LEFT_CM = 1.13
COMBINED_TOP_CM = 6.3
COMBINED_WIDTH_CM = 23.8
COMBINED_HEIGHT_CM = 8.5
