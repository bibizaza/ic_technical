...
def _build_subtitle_prompt(instruments: dict) -> str:
    ...
    lines = [
        ...
        "",
        "RULE 4 — STREAK COUNT: Each instrument's data includes 'Rating streak: X for N consecutive",
        "  weeks (pre-verified)'. This count is computed in Python by grouping history.json entries",
        "  by ISO week and counting backwards. Use EXACTLY this number. Do NOT count history",
        "  entries yourself. If no streak field appears, do not mention a streak at all.",
        "",
