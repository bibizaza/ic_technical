...
INSTRUMENT_MAP = {
    ...
    "SMI":        ("SMI",      "SMI_high",        "SMI_high",      "SMI Index"),
    ...
    "Silver":     ("SILVER",   "SILVER_high",     "SILVER_low",    "SI1 Comdty"),
    "Platinum":   ("PLATINUM", "PLATINUM_high",   "PLATINUM_low",  "PL1 Comdty"),
    "Palladium":  ("PALLADIUM","PALLADIUM_high",  "PALLADIUM_low", "PA1 Comdty"),
    "Oil":        ("OIL",      "OIL_high",        "OIL_low",       "CL1 Comdty"),
    "Copper":     ("COPPER",   "COPPER_high",     "COPPER_low",    "HG1 Comdty"),
    ...
    "Solana":     ("SOL",      "SOL_high",        "SOL_low",       "XSOLUSD Curncy"),
    "Binance":    ("BNB",      "BNB_high",        "BNB_low",       "XBNBUSD Curncy"),
}

# Bloomberg ticker → MARS column name (for peer data in the wide DataFrame)
TICKER_TO_MARS_COL = {
    "SPX Index":      "SPX",
    "SHSZ300 Index":  "SHSZ300 Index",
    "NKY Index":      "NKY",
    "SASEIDX Index":  "TASI",
    "SENSEX Index":   "SENSEX",
    "DAX Index":      "DAX",
