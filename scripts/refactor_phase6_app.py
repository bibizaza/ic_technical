#!/usr/bin/env python3
"""
Phase 6 Refactoring: Consolidate app.py show_ functions

This script consolidates the 3 nearly identical technical analysis functions:
1. Equity section in show_technical_analysis_page (450 lines)
2. show_commodity_technical_analysis (375 lines)
3. show_crypto_technical_analysis (334 lines)

Into a single generic function with configuration.
...
BACKUP_FILE = Path("app_phase6_backup.py")

# Create configuration structure that will be added to app.py
INSTRUMENT_CONFIG = '''
# ============================================================================
...
def create_generic_function():
    """Create the generic show_instrument_analysis function."""
    return '''
...
def main():
    """Apply Phase 6 refactoring to app.py."""
    print("=" * 80)
    print("PHASE 6 REFACTORING - Consolidate app.py show_ functions")
    print("=" * 80)
    print()
    ...
    print()
    print("This refactoring will:")
    print("  1. Add INSTRUMENT_CONFIG dictionary (~50 lines)")
    print("  2. Add show_instrument_analysis generic function (~150 lines)")
    print("  3. Replace show_commodity_technical_analysis (~375 lines)")
    print("  4. Replace show_crypto_technical_analysis (~334 lines)")
    print("  5. Simplify Equity section in show_technical_analysis_page")
    print()
    print("Expected net reduction: ~800-1,000 lines")
    print()
    print("⚠️  WARNING: This is a complex refactoring.")
    print("    Manual review and testing recommended.")
    print()
    print("To proceed, you'll need to manually:")
    print("  1. Add INSTRUMENT_CONFIG before show_technical_analysis_page")
    print("  2. Add show_instrument_analysis function")
    print("  3. Replace the 3 show_ functions with calls to show_instrument_analysis")
    print()
    print("Configuration template saved to: app_phase6_config.py")

    # Save the configuration and generic function to a separate file
    with open("app_phase6_config.py", "w") as f:
        f.write("# Phase 6 Configuration Template\n")
        f.write("# Add this configuration before show_technical_analysis_page\n\n")
        f.write(INSTRUMENT_CONFIG)
        f.write("\n\n# Generic function to replace the 3 asset-specific functions\n")
        f.write(create_generic_function())
