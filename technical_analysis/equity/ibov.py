...
def _get_ibov_technical_score(excel_obj_or_path) -> Optional[float]:
    """
    Retrieve the technical score for IBOV.
    Uses common helper with instrument-specific ticker.
    """
    return _get_technical_score_generic(excel_obj_or_path, "IBOV INDEX")
...
def _get_ibov_momentum_score(excel_obj_or_path) -> Optional[float]:
    """
    Retrieve the momentum score for IBOV.
    Uses common helper with instrument-specific ticker.
    """
    return _get_momentum_score_generic(excel_obj_or_path, "IBOV INDEX")
