"""
Refactored Sensex technical analysis module using base instrument class.
...
# Import MARS scorer
try:
    from mars_engine.mars_lite_scorer import generate_sensex_score_history
except Exception:
    generate_sensex_score_history = None
...
_config = InstrumentConfig(
    ...
    mars_scorer_func=generate_sensex_score_history,
)
...
def insert_sensex_technical_chart(
    ...
    """Insert a technical chart into the Sensex slide."""
...
def insert_sensex_technical_score_number(prs: Presentation, excel_file) -> Presentation:
    """Insert the Sensex technical score into the slide."""
    return _instrument.insert_technical_score_number(prs, excel_file)


def insert_sensex_momentum_score_number(
    prs: Presentation,
    excel_file,
    price_mode: str = "Last Price",
) -> Presentation:
    """Insert the Sensex momentum score into the slide."""
...
def insert_sensex_subtitle(prs: Presentation, subtitle: str) -> Presentation:
    """Insert a subtitle into the Sensex slide."""
...
def _get_sensex_momentum_score(
    excel_obj_or_path,
    price_mode: str = "Last Price",
) -> Optional[float]:
    """Retrieve the MARS momentum score for Sensex."""
    return _instrument._get_momentum_score(excel_obj_or_path, price_mode)


# Stub functions for compatibility
def insert_sensex_technical_chart_with_callout(prs: Presentation, *args, **kwargs) -> Presentation:
    """Insert chart with callout (stub)."""
    return insert_sensex_technical_chart(prs, *args, **kwargs)


def insert_sensex_technical_chart_with_range(prs: Presentation, *args, **kwargs) -> Presentation:
    """Insert chart with range gauge (stub)."""
    return insert_sensex_technical_chart(prs, *args, **kwargs)


def insert_sensex_average_gauge(prs: Presentation, *args, **kwargs) -> Presentation:
    """Insert average gauge (stub)."""
    return prs


def insert_sensex_technical_assessment(prs: Presentation, *args, **kwargs) -> Presentation:
    """Insert technical assessment (stub)."""
    return prs


def insert_sensex_source(prs: Presentation, *args, **kwargs) -> Presentation:
