"""
Refactored SMI technical analysis module using base instrument class.
...
# Import MARS scorer
try:
    from mars_engine.mars_lite_scorer import generate_smi_score_history
except Exception:
    generate_smi_score_history = None
...
_config = InstrumentConfig(
    ...
    mars_scorer_func=generate_smi_score_history,
)
...
def insert_smi_technical_chart(
    ...
    """Insert a technical chart into the SMI slide."""
...
def insert_smi_momentum_score_number(
    prs: Presentation,
    excel_file,
    price_mode: str = "Last Price",
) -> Presentation:
...
def insert_smi_subtitle(prs: Presentation, subtitle: str) -> Presentation:
    """Insert a subtitle into the SMI slide."""
...
def _get_smi_momentum_score(
    excel_obj_or_path,
    price_mode: str = "Last Price",
) -> Optional[float]:
    """Retrieve the MARS momentum score for SMI."""
    return _instrument._get_momentum_score(excel_obj_or_path, price_mode)


# Stub functions for compatibility
def insert_smi_technical_chart_with_callout(prs: Presentation, *args, **kwargs) -> Presentation:
    """Insert chart with callout (stub)."""
    return insert_smi_technical_chart(prs, *args, **kwargs)


def insert_smi_technical_chart_with_range(prs: Presentation, *args, **kwargs) -> Presentation:
    """Insert chart with range gauge (stub)."""
    return insert_smi_technical_chart(prs, *args, **kwargs)


def insert_smi_average_gauge(prs: Presentation, *args, **kwargs) -> Presentation:
    """Insert average gauge (stub)."""
    return prs


def insert_smi_technical_assessment(prs: Presentation, *args, **kwargs) -> Presentation:
    """Insert technical assessment (stub)."""
    return prs


def insert_smi_source(prs: Presentation, *args, **kwargs) -> Presentation:
